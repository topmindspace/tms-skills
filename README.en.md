...
|-------|---------|--------------|
| [`top-ppt-html`](./top-ppt-html/) | **0.1.15** | Formal business decks: paginated HTML + editable 16:9 PPTX; dual delivery · MD3-inspired density; 3 modes × 9 styles; strict 0/0 |

Installer [`@topmindspace/tms-skills`](https://www.npmjs.com/package/@topmindspace/tms-skills) is also **0.1.15** (whole-repo same-tag releases).
...
npx @topmindspace/tms-skills@0.1.15 install top-ppt-html   # pin
```
